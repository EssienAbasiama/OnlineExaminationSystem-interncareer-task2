							...
							<div class="card">
								...
								<div class="card-body">
										...
										<div class="row">
										 ...
										 <form class="form-horizontal title1" name="form" action="update.html?n=' . @$_GET['n'] . '&eid=' . @$_GET['eid'] . '&ch=4 "  method="POST">
										<fieldset>
										<b>Question number<br />
										<div class="form-group">
										  <label class="col-md-12 control-label" for=""></label>  
										  <div class="col-md-12">
										  <textarea rows="3" cols="5" name="" class="form-control" placeholder="Write question number here..." required="true"></textarea>  
										  </div>
										</div>
										<div class="form-group">
										  <label class="col-md-12 control-label" for="1"></label>  
										  <div class="col-md-12">
										  <input id="1" name="1" placeholder="Enter option a" class="form-control input-md" type="text" required="true">
										...
										<div class="form-group">
										  ...
										  <div class="col-md-12">
										  <input id="2" name="2" placeholder="Enter option b" class="form-control input-md" type="text" required="true">
										...
										<select id="ans" name="ans' . $i . '" placeholder="Choose correct answer " class="form-control input-md" required="true">
